...
public class FeiteTaskName {
    public static final String FEITE_REGION_DIFF = "KPI_FEITE_REGION_DIFF";
    public static final String FEITE_REGION_RAINFALL_DIFF = "KPI_FEITE_REGION_RAINFALL_DIFF";
    public static final String FEITE_REGION_DISASTER_NUM_DIFF = "KPI_FEITE_REGION_DISASTER_NUM_DIFF";
